...
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_MAGNIDS
# endif
# define machine_is_magnids()	(machine_arch_type == MACH_TYPE_MAGNIDS)
#else
# define machine_is_magnids()	(0)
#endif
